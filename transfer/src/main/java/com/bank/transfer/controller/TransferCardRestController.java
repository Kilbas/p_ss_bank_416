...
public class TransferCardRestController {
    ...
    @PostMapping
    public ResponseEntity<CardTransfer> createCardTransfer(@RequestBody TransferDTO transferDTO) {
        CardTransfer cardTransfer = TransferMapper.dtoToCardTransfer(transferDTO);
