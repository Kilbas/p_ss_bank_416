...
public class TransferCardRestControllerTest {
    ...
    @Nested
    @DisplayName("Тесты получения CardTransfer (GET)")
    class GetCardTransfer {
        ...
        @Test
        @DisplayName("Успешное получение CardTransfer по id")
    ...
    @Nested
    @DisplayName("Тесты создания CardTransfer (POST)")
    class CreateCardTransfer {

        @Test
        @DisplayName("Успешное добавление CardTransfer")
        ...
        @Test
        @DisplayName("Попытка добавления CardTransfer с невалидными данными")
    ...
    @Nested
    @DisplayName("Тесты обновления CardTransfer (PUT)")
    class UpdateCardTransfer {
        ...
        @Test
        @DisplayName("Попытка обновления CardTransfer с невалидными данными")
    ...
    @Nested
    @DisplayName("Тесты удаления CardTransfer (DELETE)")
    class DeleteCardTransfer {
